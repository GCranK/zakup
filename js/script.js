    ...
    const products = {
        ...
        kitchen: {
            "Мясо": [
                ...
                "Сосиски", "Салями", "Докторская колбаса", "Жир", "Баварские колбаски", "Ветчина"
            ],
            "Фрукты/овощи": [
            ...
            "Бакалея": [
                ...
                "Галина бланка курица", "Галина бланка говядина", "Chococream Большой", "Chococream маленький", "Дрожжи ангел"
            ],
            "Молочные продукты": [
