    ...
    const products = {
        bar: {
            ...
            "Бакалея": [
                ...
                "Черный молотый перец", "Сахар пакетики", "Сахарные стики", "Лёд"
            ],
            "Напитки": [
            ...
            "Канцелярия": ["Бумага А4", "Термобумага для чеков большая", "Термобумага для чеков маленькая", "Стикеры для доски"],
            ...
            "Хоз. товары": ["Пакеты для мусора большие", "Жидкое мыло", "Тряпка дельфин", "Тряпка дельфин черная", "Перчатки черные M"]
        },
        kitchen: {
            "Мясо": [
            ...
            "Молочные продукты": [
                ...
                "Пармезан", "Виола сыр", "Творожный сыр", "Дорблю сыр", "Чиз сыр (пластинки)", "Сыр моцарелла"
            ],
            "Прочее": [
            ...
            "Хоз. товары": [
                "Пакеты для мусора большие", "Отрывные маленькие пакеты", "Жидкое мыло", "Марля", "Перчатки черные M",
                "Перчатки черные L"
            ],
        },
        household: {
